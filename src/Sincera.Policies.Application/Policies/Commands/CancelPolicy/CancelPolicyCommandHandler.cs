...
public sealed class CancelPolicyCommandHandler(
    ...
    IOptions<CancellationOptions> cancellationOptions) : IRequestHandler<CancelPolicyCommand, CancelPolicyResponse>
{
    private readonly IPolicyRepository _policies = policies;
    private readonly IClaimRepository _claims = claims;
    private readonly IUnitOfWork _unitOfWork = unitOfWork;
    private readonly IClock _clock = clock;
    private readonly CancellationPolicy _cancellationPolicy = cancellationPolicy;
    private readonly CancellationOptions _cancellationOptions = cancellationOptions.Value;
